...
public class ExcelServiceImpl implements ExcelService, InitializingBean, ApplicationContextAware {
    ...
    @Override
    public <T> Collection<ImportRecord<T>> convertRecords(Class<?> clazz, Class<T> dataType, File excelFile) {
    ...
    private ExcelImportMetadata getMetadata(Class<?> clazz) {
        ...
        String relativeName = "classpath:/" + FASTBALL_RESOURCE_PREFIX + viewFilePath + ExcelConstants.RECORD_TYPE_META_FILE_SUFFIX;
