...
import static dev.fastball.component.builtin.jpa.FastballAptJpaConstants.*;
import static dev.fastball.component.builtin.jpa.generator.JpaQueryModelProcessor.QUERY_MODEL_PACKAGE;
import static dev.fastball.component.builtin.jpa.generator.JpaQueryModelProcessor.QUERY_MODEL_PREFIX;
...
public class JpaTableGenerator extends BuiltinGenerator {
    ...
    private MethodSpec buildLoadDataMethod(TypeElement element, ClassName queryModel) {
        CodeBlock codeBlock = CodeBlock.builder()
                ...
                .addStatement("page = " + JPA_REPO_FIELD_NAME + ".findAll(dev.fastball.component.builtin.jpa.query.QueryUtils.pageable(params))")
                .nextControlFlow("else")
                .addStatement("page = " + JPA_REPO_FIELD_NAME + ".findAll(params.getSearch().condition(), dev.fastball.component.builtin.jpa.query.QueryUtils.pageable(params))")
                .endControlFlow()
