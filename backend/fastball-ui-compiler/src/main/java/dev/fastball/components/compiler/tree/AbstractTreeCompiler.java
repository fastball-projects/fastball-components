...
import dev.fastball.components.tree.metadata.TreeProps_AutoValue;
import dev.fastball.core.component.Component;
import dev.fastball.components.tree.metadata.TreeProps;
...
//        }
        ...
        if (config != null) {
            fieldNames = new TreeProps.TreeFieldNames(config.keyField(), config.titleField(), config.childrenField(), config.hasChildrenField(), config.searchKeyField(), config.searchTitleField());
